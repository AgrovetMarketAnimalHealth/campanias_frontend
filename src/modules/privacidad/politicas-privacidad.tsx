...
function BulletList({ items }: { items: (string | React.ReactNode)[] }) {
  return (
    <ul className="space-y-3 mt-2">
      {items.map((item, i) => (
        <li key={i} className="flex gap-3 text-lg leading-relaxed text-gray-700">
...
function SectionTitle({ children }: { children: React.ReactNode }) {
  return (
    <div className="flex items-center gap-2 mb-5">
      ...
      <h3 className="text-base font-bold uppercase tracking-widest" style={{ color: BRAND_HEX }}>
        {children}
      </h3>
    </div>
  );
...
export function PoliticasPrivacidadPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col font-sans" style={{ backgroundColor: "#f7f5fc" }}>
      ...
      <div
        className="sticky top-0 z-50 flex items-center justify-between px-6 md:px-8 py-3 bg-white"
        style={{
      ...
      >
        ...
        >
          <span className="text-lg font-semibold text-gray-700">Consentimiento Informado</span>
        </div>

        <Badge className="text-white text-sm font-semibold px-2 py-0.5" style={{ backgroundColor: BRAND_HEX, border: "none" }}>
          Ley N° 29733
        </Badge>
      </div>
      ...
      >
        ...
        >
          ...
          <div className="relative z-10 max-w-7xl mx-auto px-6 md:px-8 py-14 md:py-20 text-white">
            <p className="text-sm font-semibold uppercase tracking-[0.2em] opacity-70 mb-3">AGROVET MARKET S.A.</p>
            <p className="text-base font-semibold uppercase tracking-widest opacity-80 mb-1">Documento Legal</p>
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-black tracking-tight leading-tight mb-6">CONSENTIMIENTO INFORMADO</h1>
            <div className="flex flex-wrap gap-3">
              {["RUC: 20250406941", "Ley N° 29733", "D.S. N° 016-2024-JUS"].map((item) => (
                <span key={item} className="text-sm font-medium px-3 py-1.5 rounded-full" style={{ backgroundColor: "rgba(255,255,255,0.15)", border: "1px solid rgba(255,255,255,0.25)" }}>
                  {item}
                </span>
              ))}
            </div>
        ...
        {/* Body - ANCHO AUMENTADO y texto más grande */}
        <div className="max-w-7xl mx-auto px-4 md:px-8 py-12 space-y-8">

          {/* Intro */}
          <Alert className="border-0 bg-white shadow-md rounded-xl">
            <AlertDescription>
          ...
          <Card className="border-0 shadow-md overflow-hidden rounded-xl">
            <div className="px-6 md:px-8 py-5" style={{ background: `linear-gradient(90deg, ${BRAND_LIGHT}, transparent)` }}>
            ...
            <CardContent className="p-0">
              ...
              >
                ...
                <AccordionItem value="c1" className="border-0 px-6 md:px-8">
                  <AccordionTrigger className="text-lg font-semibold text-gray-800 hover:no-underline py-4">
                    1. Identidad y Domicilio del Titular del Banco de Datos Personales o Encargado del Tratamiento
                  </AccordionTrigger>
                  <AccordionContent className="text-lg text-gray-700 leading-relaxed pb-5">
                ...
                <AccordionItem value="c2" className="border-0 px-6 md:px-8">
                  <AccordionTrigger className="text-lg font-semibold text-gray-800 hover:no-underline py-4">
                    2. Finalidad del Banco de Datos Personales de AGROVET MARKET S.A.
                  </AccordionTrigger>
                  <AccordionContent className="text-lg text-gray-700 leading-relaxed pb-5 space-y-3">
                ...
                <AccordionItem value="c4" className="border-0 px-6 md:px-8">
                  <AccordionTrigger className="text-lg font-semibold text-gray-800 hover:no-underline py-4">
                    4. Plazo durante el cual se Conservarán los Datos Personales
                  </AccordionTrigger>
                  <AccordionContent className="pb-5">
                    <div className="rounded-xl p-5 text-center shadow-sm" style={{ backgroundColor: BRAND_LIGHT }}>
                      <p className="text-sm font-bold uppercase tracking-widest mb-2" style={{ color: BRAND_HEX }}>Plazo de conservación</p>
                      <p className="text-5xl font-black text-gray-800">10 años</p>
                    </div>
                  </AccordionContent>
                </AccordionItem>

                <AccordionItem value="c5" className="border-0 px-6 md:px-8">
                  <AccordionTrigger className="text-lg font-semibold text-gray-800 hover:no-underline py-4">
                  ...
                  <AccordionContent className="text-lg text-gray-700 leading-relaxed pb-5 space-y-3">
                    <p>La Política de Tratamiento de Datos Personales de AGROVET MARKET S.A. obra en su página Web <a href="https://shop.agrovetmarket.com/content-7-politicas-de-privacidad" style={{ color: BRAND_HEX }} className="underline hover:opacity-80 transition-opacity" target="_blank" rel="noopener noreferrer">https://shop.agrovetmarket.com/content-7-politicas-de-privacidad</a>. Asimismo, el titular de Datos Personales, tiene derecho de acceder a sus datos en posesión de AGROVET MARKET S.A. El titular de Datos Personales podrá en todo momento revocar el consentimiento otorgado expresamente (dejándose constancia que el premio no podrá ser ejecutado al efectuar esta revocación) y/o ejercer todos los derechos que le confiere la normativa de Protección de Datos Personales, mediante la presentación de una solicitud, acompañada de copia de su D.N.I. o Carnet de Extranjería y enviando su solicitud y/o consultas a:</p>
                    <BulletList items={[
                      <>Correo electrónico: <a href="mailto:protecciondedatos@agrovetmarket.com" style={{ color: BRAND_HEX }} className="underline hover:opacity-80 transition-opacity">protecciondedatos@agrovetmarket.com</a></>,
            ...
            <CardContent className="px-6 md:px-8 py-6">
              <div className="grid sm:grid-cols-2 gap-5">
                {["Fecha", "Lugar", "Nombre y apellidos", "Tipo y número de documento de identidad", "Domicilio", "Correo electrónico"].map((label) => (
                  <div key={label} className="flex flex-col gap-1">
                    <span className="text-sm font-bold uppercase tracking-widest" style={{ color: BRAND_HEX }}>{label}</span>
              ...
              <div className="flex justify-center">
                <div className="text-center">
                  ...
                  <p className="text-lg font-semibold text-gray-700">Firma del Declarante</p>
                </div>
              </div>
            </CardContent>
          </Card>
          ...
          <div className="flex justify-center pb-10">
            <div className="rounded-2xl px-10 py-6 text-center bg-white shadow-md">
              ...
              />
              <p className="font-bold text-gray-800 text-lg">AGROVET MARKET S.A.</p>
              <p className="text-sm text-gray-400 mt-1 uppercase tracking-wider">RUC 20250406941</p>
            </div>
          </div>
